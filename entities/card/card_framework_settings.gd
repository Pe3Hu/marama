...
## 
const LAYOUT_DEFAULT_TABLET_SIZE: Vector2 = Vector2(1100,500)
## 
const LAYOUT_DEFAULT_HAND_SIZE: Vector2 = Vector2(800, 270)
## 
const LAYOUT_DEFAULT_PILE_SIZE: Vector2 = Vector2(400, 210)
...
const LAYOUT_STACK_GAP: int = 0
## Maximum cards to display in stack before hiding
const LAYOUT_MAX_STACK_DISPLAY: int = 10
